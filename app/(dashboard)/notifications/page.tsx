                ...
                <motion.div
                  ...
                  style={{
                    borderColor: !n.isRead
                      ? "var(--border-active)"
                      : "var(--border)",
                    background: !n.isRead ? "var(--gold-glow)" : undefined,
                  }}
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {/* Body — the main message e.g. "USD 20,000 has been added..." */}
                      {n.body && (
                        <p
                      ...
                      {/* Footer: type badge + ref parsed from body */}
                      <div className="flex items-center gap-2 mt-3">
                        ...
                        {n.body?.includes("Ref:") && (
                          <span
                            ...
                            style={{ color: "var(--text-muted)" }}
                          >
                            {n.body.split("Ref:")[1]?.trim()}
                          </span>
                        )}

                        {/* {n.data?.transactionId && (
                          <a
                            href={`/transactions/${n.data.transactionId}`}
